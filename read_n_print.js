...
function guardarSuma(filePath, originalFilePath) {
  return new Promise((resolve, reject) => {
    fs.readFile(filePath, 'utf8', (error, data) => {
      ...
      //Escribir los numeros en el archivo original.txt
      ...
      fs.writeFile(filePath, suma.toString(), 'utf8', (error) => {
        ...
        resolve(`La suma de los números se ha guardado correctamente en el archivo: ${filePath}`);
      });
    });
  });
}
